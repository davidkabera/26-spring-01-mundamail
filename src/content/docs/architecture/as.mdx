...
<a href="/26-spring-01-mundamail/diagrams/index.html#/view/systemContext/" target="_blank">Open diagram in full screen →</a>

<iframe 
  src="/26-spring-01-mundamail/diagrams/index.html#/view/systemContext/"
  width="100%"
  height="85vh"
  frameborder="0"
